...
/**
 * obtener-textos.php
 * Obtiene los textos desde Upstash Redis (Vercel)
 */
...
// =============================================
// 1. CONFIGURACIÓN DE UPASTASH REDIS
// =============================================
...
if (!$kvUrl || !$kvToken) {
    // Si no hay variables, devolver datos por defecto
    $defaultData = [
        "header" => [
...
if ($httpCode === 200 && $response) {
    ...
    // Si no hay datos en Redis, devolver datos por defecto
    $defaultData = [
        "header" => [
            "logo_texto" => "Cerrajeria y Aluminio Francisco Rivera",
            "logo_sub" => "e Hijo"
